export default function About() {
  return (
    <section className="px-4 flex flex-col gap-12 pt-16 sm:pt-24 max-w-md sm:max-w-lg md:max-w-3xl lg:max-w-6xl mx-auto md:text-left md:px-8 relative h-screen">
      <div className="flex flex-col gap-8 sm:flex-row md:gap-0">
        ...
        <p className="text-md md:order-1 md:text-lg md:max-w-prose md:my-auto ">
          Soy Matías, tengo 22 años y desde que soy chico investigo y me encanta
          saber cómo funcionaban las cosas que me interesaban (juegos, webs,
          programas) internamente, cómo estaban programados, cómo estaban
          creados.
        </p>
      </div>

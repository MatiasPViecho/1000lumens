export const Middle = () => {
  return (
    <div className="relative h-[400px] sm:h-[450px] md:h-[500px] overflow-hidden pointer-events-none">
      <div
        tabIndex={7}
        className="absolute left-4 top-6 sm:top-12 md:top-24 z-10 font-bold text-2xl sm:text-3xl max-w-[30ch] text-white tracking-wide pr-8 pl-2 text-balance flex flex-col gap-32 lg:text-right"
      >
